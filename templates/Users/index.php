...
<nav class="top-nav">
        ...
        <div class="top-nav-links">
            ...
            <?php
            if(($curr_user->role === 'staff') || ($curr_user->role === 'admin')){
                echo ($this->Html->link(
                    '<span class="icon text-white-40"><i class="icon-info-blocks material-icons">add</i></span>
                <span class="text">New User</span>',
                    ['action' => 'add'],
                    ['escape' => false,'class'=>'btn btn-success btn-icon-split']));
                   
                    echo($this->Html->link(__(
                    '<span class="icon text-white-40"><i class="icon-info-blocks material-icons">view_list</i></span>
                 <span class="text">Archives</span>'
                ), ['controller'=>'Users','action' => 'archives'],['escape' => false, 'class'=>'btn btn-info btn-icon-split']));
            }
