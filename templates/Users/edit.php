 ...
 * @var string[]|\Cake\Collection\CollectionInterface $preferences
...
<h1 class="h3 mb-4 text-gray-800">Edit User Details</h1>
<div class="row">
    <aside class="column">
        <div class="side-nav">
        </div>
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                ...
                                <br>
                                <?php
                                echo $this->Form->control('site_access', ['label' => " Give this user site access? (archive)"]);
                                ?>
                                <br>
                                <?php
