    ...
    <div class="top-nav-links">
        ...
        <?= $this->Html->link(__(
            '<span class="icon text-white-40"><i class="icon-info-blocks material-icons">view_list</i></span>
                 <span class="text">View Properties</span>'
        ), ['controller'=>'Properties','action' => 'index'],['escape' => false, 'class'=>'btn btn-info btn-icon-split']) ?>
    </div>
</nav>
<br>
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Archived Properties</h6>
    </div>
    <div class="card-body">
